...
fn codegen_cast<'ctx>(
    ...
    let op = match kind {
        ...
        hir::CastKind::Int_Trunc => values::InstructionOpcode::Trunc,
        hir::CastKind::IntS_Sign_Extend => values::InstructionOpcode::SExt,
        hir::CastKind::IntU_Zero_Extend => values::InstructionOpcode::ZExt,
        hir::CastKind::Float_to_IntS => values::InstructionOpcode::FPToSI,
        hir::CastKind::Float_to_IntU => values::InstructionOpcode::FPToUI,
        hir::CastKind::IntS_to_Float => values::InstructionOpcode::SIToFP,
        hir::CastKind::IntU_to_Float => values::InstructionOpcode::UIToFP,
