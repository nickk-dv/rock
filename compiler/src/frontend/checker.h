...
static option<Ast_Type> check_expr_type(Checker_Context* cc, Type_Context* context, Ast_Expr* expr);
static option<Ast_Type> check_expr(Checker_Context* cc, Type_Context* context, Ast_Expr* expr);
static option<Ast_Type> check_term(Checker_Context* cc, Type_Context* context, Ast_Term* term);
...
static option<Ast_Type> check_unary_expr(Checker_Context* cc, Type_Context* context, Ast_Unary_Expr* unary_expr);
static option<Ast_Type> check_binary_expr(Checker_Context* cc, Type_Context* context, Ast_Binary_Expr* binary_expr);
