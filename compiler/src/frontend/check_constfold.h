...
static option<Literal> constfold_unary_minus(Check_Context* cc, Literal rhs, Literal_Kind kind);
static option<Literal> constfold_unary_logic_not(Check_Context* cc, Literal rhs, Literal_Kind kind);
static option<Literal> constfold_unary_bitwise_not(Check_Context* cc, Literal rhs, Literal_Kind kind);
static option<Literal> constfold_unary_address_of(Check_Context* cc, Literal rhs, Literal_Kind kind);
static option<Literal> constfold_unary_dereference(Check_Context* cc, Literal rhs, Literal_Kind kind);
